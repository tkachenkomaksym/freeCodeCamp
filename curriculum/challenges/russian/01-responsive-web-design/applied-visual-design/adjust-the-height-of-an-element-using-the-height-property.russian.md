...
## Description
<section id="description"> Вы можете установить высоту элемента, используя свойство <code>height</code> в CSS, подобное свойству <code>width</code> . Вот пример, который изменяет высоту изображения на 20 пикселей: <blockquote> img { <br> высота: 20 пикселей; <br> } </blockquote></section>
